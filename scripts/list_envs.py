...
All the environments are registered in the `Twip_v2` extension. They start
...
import Twip_v2.tasks  # noqa: F401

# PLACEHOLDER: Extension template (do not remove this comment)
with contextlib.suppress(ImportError):
    import Twip_v2.tasks_experimental  # noqa: F401
...
def _format_presets(preset_map: dict | None) -> str:
    ...
    Args:
        preset_map: Mapping of :class:`~Twip_v2.utils.preset_target.PresetTarget`
    ...
    if preset_map is None:
        return "(unavailable)"
    from Twip_v2.utils.preset_target import PresetTarget
...
def main():
    """Print all environments registered in `Twip_v2` extension."""
    ...
    if args_cli.show_presets:
        from Twip_v2.utils.preset_cli import enumerate_task_presets
